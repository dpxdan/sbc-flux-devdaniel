...
class event_guard_form extends common
{
    ...
    function get_whitelist_form_fields($id = 0)
    {
        $form['forms'] = array(
    ...
    function get_event_guard_search_form()
    {
    ...
    function build_event_guard_list_for_admin()
    {
        $grid_field_arr = json_encode(array(
            ...
            array(
                gettext('Chain'),
                '110', 'filter', '', '', '', '', 'true', 'center'
            ),
            array(
                gettext('Extension'),
                '180', 'extension', '', '', '', '', 'true', 'left'
            ),
            array(
                gettext('User Agent'),
                '200', 'user_agent', '', '', '', '', 'true', 'left'
            ),
            array(
                gettext('Hostname'),
                '130', 'hostname', '', '', '', '', 'true', 'left'
            ),
            array(
                gettext('Date'),
                '150', 'log_date', 'log_date', 'log_date', 'convert_GMT_to', '', 'true', 'center'
            ),
            array(
                gettext('Status'),
                '100', 'log_status', '', '', '', '', 'true', 'center'
            ),
            array(
                gettext('Action'),
                '160', '', '', '',
    ...
    function build_whitelist_list_for_admin()
    {
        $grid_field_arr = json_encode(array(
            array(
                "<input type='checkbox' name='chkAll' class='ace checkall'/><label class='lbl'></label>",
    ...
    function build_whitelist_grid_buttons()
    {
        $buttons_json = json_encode(array(
            array(
                gettext('Add CIDR'),
            ...
            array(
                gettext('Reload IP Map'),
                'green btn btn-line-success btn',
                'fa fa-refresh fa-lg',
                'button_action',
                '/event_guard/event_guard_whitelist_rescan/',
                'popup',
                '',
                'create'
            )
    ...
    function get_log_edit_form_fields($id = 0)
    {
        $form['forms'] = array(
