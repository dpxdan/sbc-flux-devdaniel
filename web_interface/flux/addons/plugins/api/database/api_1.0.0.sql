DROP TABLE IF EXISTS dialer_device_info;
  ...
  INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`, `field_rules`) VALUES (NULL, 'apns_topic', 'APNS Topic', '0', 'default_system_input', 'Define APNS topic name(Define value if you have personalised dialer and want to send notification from our central notification server.). EG. com.flux.iap.voip', '2021-09-03 00:00:00', '0', '0', 'global', 'Dialer Configuration', '');

  INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`, `field_rules`) VALUES (NULL, 'voip_topic', 'VOIP Topic', '0', 'default_system_input', 'Define VOIP topic name(Define value if you have personalised dialer and want to send notification from our central notification server.). EG. com.flux.iap.voip', '2021-09-03 00:00:00', '0', '0', 'global', 'Dialer Configuration', '') ;
