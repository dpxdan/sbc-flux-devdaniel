...
class Form {
	...
	function check_permissions() { 
		if ($this->CI->session->userdata ( 'user_login' ) == TRUE) {
			...
			if ($this->CI->session->userdata ( 'userlevel_logintype' ) != -1 && $this->CI->session->userdata ( 'userlevel_logintype' ) != 2 && $this->CI->session->userdata ( 'userlevel_logintype' ) != 4) {
				$module_info [] = 'user';
			}
			...
			if (in_array ( $module [0], $module_info ) || (isset($url_explode[3]) && $url_explode[3] == 'dashboard') || (isset($url_explode[3]) && $url_explode[3] == 'login_activity') || (isset($url_explode[3]) && $url_explode[4] == 'systems_list') ) {
				...
				$this->CI->session->set_userdata ( 'flux_errormsg', 'You do not have permission to access this module..!' );
				...
				if (isset ( $fieldvalue ) && $fieldvalue != '') {
					...
					if ($fieldvalue [2] == 'SELECT' && ! isset ( $fieldvalue [13] )) {
						...
						if ($fieldvalue [7] != '' && $fieldvalue [8] != '') {
							...
							if ($fieldset_key == gettext ( 'System Configuration Information' ) || ($fieldset_key == 'Billing Information' && $fieldvalue [0] == 'Force Trunk') || ($fieldset_key == 'Card Information' && $fieldvalue [0] == 'Rate Group') || ($fieldset_key == 'Billing Information' && $fieldvalue [0] == 'Account')|| ($fieldset_key == 'Rate Information' && ($fieldvalue [0] == 'Country' || $fieldvalue [0] == 'Call Type'))|| ($fieldset_key == 'Ratedeck Information' && ($fieldvalue [0] == 'Call Type')) || $fieldset_key == 'FluxSBC Devices' && $fieldvalue [0] == 'Rate Group' || ($fieldset_key == 'Origination Rate Add/Edit' && $fieldvalue [0] == 'Trunks') || $fieldset_key == 'Billing Information' && $fieldvalue [0] == 'Rate Group' || ($fieldset_key == 'Information' && $fieldvalue [0] == 'Failover GW Name #1') || ($fieldset_key == 'Information' && $fieldvalue [0] == 'Failover GW Name #2') || ($fieldset_key == 'Information' && $fieldvalue [0] == 'Rate Group') || ($fieldset_key == 'Sip Devices' && $fieldvalue [0] == 'Sip Profile') || ($fieldset_key == 'Sip Devices' && $fieldvalue [0] == 'Account') || ($fieldset_key == 'Account Settings' && $fieldvalue [0] == 'Localization') || ($fieldset_key == 'Settings' && $fieldvalue [0] == 'Localization')) {
