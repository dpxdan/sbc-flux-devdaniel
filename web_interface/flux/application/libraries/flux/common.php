...
class common {
	...
	function get_field_name_new($select, $table, $where) {
	 	if (is_array ( $where )) {
	 		$where = $where;
	 	} else {
	 		$where = array (
	...
	function get_rate_group($select = "", $table = "", $rate_group) {
	...
	function get_reverse_rate($select = "", $table = "", $reverse_rate) {
	...
	function get_area_code($select = "", $table = "", $area_code) {
	...
	function get_custom_hg_type($hg_type) {
	                $hg_type_array = array (
	                                "" => ""
	                );
	...
	function get_custom_rate_group($rate_group) {
	                $rate_group_array = array (
	                                "" => ""
	                );
	...
	function get_custom_reverse_rate($reverse_rate) {
	                $reverse_rate_array = array (
	                                "" => ""
	                );
	...
	function get_entity_typebkp($select = "", $table = "", $entity_type) {
		$entity_array = array (
				'-1' => "Administrator",
				'0' => 'Customer',
				'1' => 'Reseller',
	...
	function get_entity_type_new($select = "", $table = "", $entity_type) {
	...
	function account_number_icon_new($select = "", $table = "", $number) {
		$return_value = '';
		$where = array (
				'number' => $number
		);
		...
		if ($account_res ['permission_id'] == 0) {
			$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 1) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-secondary" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
				}
		if ($account_res ['permission_id'] == 2) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 3) {
			$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-danger float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 4) {
							$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 5) {
							$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-success" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 6) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-warning" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		return $return_value;
	}
	function account_number_icon($select = "", $table = "", $number) {
		...
		if ($account_res ['type'] == '-1') {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-danger" title="Admin">'.gettext("Super Admin").'</span>';
		}
		...
		if ($account_res ['type'] == 1) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-secondary" title="Admin">'.gettext("Admin").'</span>';
				}
		if ($account_res ['type'] == 2) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="Subadmin">'.gettext("Subadmin").'</span>';
		}
		...
		if ($account_res ['permission_id'] == 6) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-warning" title="API">'.gettext("API").'</span>';
		}
		return $return_value;
	}
	function admin_number_icon($select = "", $table = "", $number) {
			$return_value = '';
			$where = array (
					'number' => $number
			);
			...
			$account_res = ( array ) $this->CI->db->get_where ( "view_accounts_permissions", $where )->first_row ();	
			if ($account_res ['permission_id'] == '-1') {
				$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
			}
		if ($account_res ['permission_id'] == 0) {
			$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 1) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-secondary" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
				}
		if ($account_res ['permission_id'] == 2) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 3) {
			$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-danger float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 4) {
							$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 5) {
							$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if ($account_res ['permission_id'] == 6) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-warning" title="'.$account_res ['permission_name'].'"> '.$account_res ['permission_name'].'</span>';
		}
		if ($number == 'admin') {
							$return_value = " <span title='Edit'>" . $number . " </span>" . '<span class="badge badge-danger" title="Super Admin">'.gettext("SuperAdmin").'</span>';
							}
		if ($account_res ['permission_id'] > 6) {
					$return_value = " <span title='Edit'>" . $account_res ['number'] . " </span>" . '<span class="badge" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
		}
		if (!isset($account_res ['permission_id'])) {
							$return_value = " <span title='Edit'>" . $number . " </span>" . '<span class="badge">"'.$number.'"</span>';
							}
			return $return_value;
		}
	...
	function build_add_orders_button($button_params, $linkid) {
		$link = base_url () . $button_params->url . "" . $linkid;
		if ($button_params->mode == 'popup') {
			return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" rel="facebox" title="Add Account Order"><i class="fa fa-reorder fa-fw"></i></a>&nbsp;';
		} else {
			return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" title="Add Account Order"><i class="fa fa-reorder fa-fw"></i></a>&nbsp;';
		}
	}
...
$cc_email_ids = strtolower($this->CI->common->get_field_name("notification_email","accounts",array("id" => $accountinfo['customer_account_id'])));
	...
	function renew_deleted_product() {
		$status_array = array (
				'0' => gettext ( 'Enable' ),
				'1' => gettext ( 'Disable' )
		);
...
/*	-1 Super
	...
	function permission_login_type_new($select = "", $table = "", $entity_type) {
					$entity_array = array (
											  '-1' => 'SuperAdmin',
												'0' => 'Customer',
												'1' => 'Reseller',
	...
	function set_search_permission_login_type_new($select = '') {
		$status_array = array (
				"" => gettext ( "--Select--" ),
	...
	function get_did_reverse_rate($select = "", $table = "", $status) {
		return ($status == 1) ? gettext ( 'Disabled' ) : gettext ( 'Enable' );
	}
	function set_did_reverse_type_search($status = '') {
		$status_array = array (
				'' => gettext ( "--Select--" ),
				'0' => gettext ( 'Enable' ),
				'1' => gettext ( 'Disabled' )
