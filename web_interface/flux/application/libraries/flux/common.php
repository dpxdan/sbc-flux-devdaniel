...
class common
{
    ...
    public function find_uniq_rendno($size = '', $field = '', $tablename = '')
    {
        if ($tablename != '') {
            $size = (int)$size;
    ...
    public function find_uniq_rendno_customer($size = '', $field = '', $tablename = '')
    {
    ...
    public function find_uniq_rendno_customer_length($min = '', $max = '', $field = '', $tablename = '')
    {
    ...
    public function find_uniq_rendno_accno($length = '', $field = '', $tablename = '', $default, $creation_count)
    {
        $number = array();
        $j = 0;
    ...
    public function get_field_count($select, $table, $where)
    {
        if (is_array($where)) {
            $where = $where;
        } else {
    ...
    public function get_field_name_new($select, $table, $where)
    {
        if (is_array($where)) {
            $where = $where;
        } else {
    ...
    public function get_field_name($select, $table, $where)
    {
        $timezone_name = $where;
    ...
    public function get_field_name_coma_new($select, $table, $where)
    {
    ...
    public function check_did_avl($select, $table, $where)
    {
        ...
        if (isset($field_name) && ! empty($field_name)) {
            if (isset($field_name [0]) && $accountinfo ['type'] != 1) {
                ...
                } elseif ($field_name [0]->parent_id != 0 && $field_name [0]->accountid != 0) {
                    if ($accountinfo['type'] == 0 || $accountinfo['type'] == 3) {
                        $flag_status = "<a href='../user_list_release/" . $field_name [0]->id . "' title='Release' onClick='return get_reliase_msg();'><span class=' label label-sm label-inverse_blue arrowed_blue-in' title='release'>Release(C)<span></a>";
                ...
                } elseif ($field_name [0]->parent_id != 0) {
    ...
    public function check_did_avl_export($number)
    {
    ...
    public function get_field_name_coma($select, $table, $where)
    {
        $value = '';
        if (is_array($where)) {
            $where = $where;
    ...
    public function set_invoice_option($select = "", $table = "", $call_type = "", $edit_value = '')
    {
    ...
    public function set_routetype($status = '')
    {
        $status_array = array(
                '0' => gettext('LCR'),
                '1' => gettext('COST')
    ...
    public function set_prorate($status = '')
    {
        $status_array = array(
                '0' => gettext('Yes'),
                '1' => gettext('No')
    ...
    public function set_prorate_verification($status = '')
    {
        $status_array = array(
                '0' => gettext('Email'),
                '1' => gettext('SMS'),
    ...
    public function set_localization_verification()
    {
    ...
    public function set_package_type($applicable_for = "")
    {
    ...
    public function get_package_type($status = '', $table = "", $applicable_for)
    {
        $package_applicable = array(
                '0' => gettext('Outbound'),
                '1' => gettext('Inbound'),
    ...
    public function set_allow($status = '')
    {
        $status_array = array(
                '1' => gettext('Yes'),
                '0' => gettext('No')
    ...
    public function set_cadup($status = '')
    {
        $status_array = array(
                '0' => gettext('Yes'),
                '1' => gettext('No')
    ...
    public function set_carrier($status = '')
    {
        $status_array = array(
                '0' => gettext('No'),
                '1' => gettext('Yes')
    ...
    public function set_allow_invoice($status = '')
    {
        $status_array = array(
                '1' => gettext('Yes'),
                '0' => gettext('No')
    ...
    public function set_pin_allow($status = '')
    {
        $status_array = array(
                '0' => gettext('Disable'),
                '1' => gettext('Enable')
    ...
    public function set_pin_allow_customer($status = '')
    {
        $status_array = array(
                '0' => gettext('No'),
                '1' => gettext('Yes')
    ...
    public function get_allow($select = "", $table = "", $status)
    {
        return ($status == 1) ? "Yes" : "No";
    }
    public function get_cadup($select = "", $table = "", $status)
    {
        return ($status == 1) ? "No" : "Yes";
    }
    public function get_carrier($select = "", $table = "", $status)
    {
        return ($status == 1) ? "No" : "Yes";
    }
    public function get_hg_type($select = "", $table = "", $hg_type)
    {
        $hg_type_array = array(
                        '' => ""
        );
        $custom_did_hg_types_result = $this->CI->db->get("did_hg_types")->result_array();

        foreach ($custom_did_hg_types_result as $result) {
            $hg_type_array [$result ['hg_type_code']] = $result ['hg_type'];
        }

        return $hg_type_array [$hg_type];
    }
    public function get_rate_group($select = "", $table = "", $rate_group)
    {
        $rate_group_array = array(
                        '' => ""
        );
        $custom_did_rate_group_result = $this->CI->db->get("pricelists")->result_array();

        foreach ($custom_did_rate_group_result as $result) {
            $rate_group_array [$result ['id']] = $result ['name'];
        }

        return $rate_group_array [$rate_group];
    }
    public function get_reverse_rate($select = "", $table = "", $reverse_rate)
    {
        $reverse_rate_array = array(
                        '' => ""
        );
        $custom_did_reverse_rate_result = $this->CI->db->get("did_reverse_rate")->result_array();

        foreach ($custom_did_reverse_rate_result as $result) {
            $reverse_rate_array [$result ['reverse_rate_code']] = $result ['reverse_rate'];
        }

        return $reverse_rate_array [$reverse_rate];
    }
    public function get_area_code($select = "", $table = "", $area_code)
    {
        $area_code_array = array(
                        '' => ""
        );
        $custom_did_area_code_result = $this->CI->db->get("dids")->result_array();

        foreach ($custom_did_area_code_result as $result) {
            $area_code_array [$result ['area_code']] = $result ['area_code'];
        }

        return $area_code_array [$area_code];
    }
    public function get_custom_hg_type($hg_type)
    {
        $hg_type_array = array(
                        "" => ""
        );
        ...
        $custom_did_hg_types_result = $this->CI->db->get("did_hg_types")->result_array();
        foreach ($custom_did_hg_types_result as $result) {
            $hg_type_array [$result ['hg_type']] = $result ['hg_type_code'];
        }
        return $hg_type_array [$hg_type];
    }
    public function get_custom_rate_group($rate_group)
    {
        $rate_group_array = array(
                        "" => ""
        );

        $custom_did_rate_groups_result = $this->CI->db->get("pricelists")->result_array();
        foreach ($custom_did_rate_groups_result as $result) {
            $rate_group_array [$result ['rate_group']] = $result ['name'];
        }
        return $rate_group_array [$rate_group];
    }
    public function get_custom_reverse_rate($reverse_rate)
    {
        $reverse_rate_array = array(
                        "" => ""
        );
        ...
        $custom_did_reverse_rate_result = $this->CI->db->get("did_reverse_rate")->result_array();
        foreach ($custom_did_reverse_rate_result as $result) {
            $reverse_rate_array [$result ['reverse_rate']] = $result ['reverse_rate_code'];
        }
        return $reverse_rate_array [$reverse_rate];
    }
    ...
    public function set_call_type_search()
    {
        $call_type_array = array(
                "" => gettext("--Select--")
        );
    ...
    public function get_call_type($select = "", $table = "", $call_type)
    {
        $call_type_array = array(
                '' => ""
        );
    ...
    public function get_custom_call_type($call_type)
    {
        $call_type_array = array(
                "" => ""
        );
    ...
    public function set_sip_config_option($option = "")
    {
        $config_option = array(
                "true" => gettext("True"),
                "false" => gettext("False")
    ...
    public function set_option_default_false($option = "")
    {
        $config_option = array(
                        "false" => gettext("False"),
                        "true" => gettext("True")
    ...
    public function get_entity_typebkp($select = "", $table = "", $entity_type)
    {
        $entity_array = array(
                '-1' => "Administrator",
                '0' => 'Customer',
    ...
    public function get_entity_type_old($select = "", $table = "", $entity_type)
    {
        $entity_array = array(
                '-1' => 'Administrator',
                '0' => 'Customer',
    ...
    public function get_entity_type($select = "", $table = "", $entity_type)
    {
        $entity_array = array(
                '-1' => "Administrator",
                '0' => 'Customer',
    ...
    public function get_entity_type_new($select = "", $table = "", $entity_type)
    {
        $this->CI->db->select("name");
        $this->CI->db->where("reseller_id", 0);
        $permissions_result = $this->CI->db->get("permissions")->result_array();
        $entity_array = array();
        $entity_array [0] = gettext("--Select--");
        foreach ($permissions_result as $result) {
            $entity_array [$result ['name']] = $result ['name'];
        }
        return $entity_array;
    }
    public function set_entity_type_customer($entity_type = "")
    {
        $entity_array = array(
                '' => gettext("--Select--"),
                '0' => gettext('Customer'),
    ...
    public function set_entity_type_admin($entity_type = "")
    {
        $entity_array = array(
                '' => gettext('--Select--'),
                '-1' => gettext('Administrator'),
                '0' => gettext('Customer'),
                '1' => gettext('Reseller'),
                '2' => gettext('Admin'),
                '3' => gettext('Provider'),
                '4' => gettext('SubAdmin'),
                '5' => gettext('SuperAdmin'),
                '6' => gettext('API')

        );
        return $entity_array;
    }
    public function set_entity_type_email_mass($entity_type = "")
    {
        $entity_array = array(
                '' => gettext("--Select--"),
                '0' => gettext('Customer'),
    ...
    public function set_sip_config_options($option = "")
    {
        $config_option = array(
                "false" => gettext("False"),
                "true" => gettext("True")
    ...
    public function set_sip_config_default($option = "")
    {
        $config_option = array(
                "" => gettext("--SELECT--"),
                "false" => gettext("False"),
    ...
    public function set_sip_bind_params($option = "")
    {
        $config_option = array(
                "" => gettext("--SELECT--"),
                "udp" => gettext("UDP"),
    ...
    public function set_sip_vad_option()
    {
        $config_option = array(
                "in" => gettext("In"),
                "out" => gettext("Out"),
    ...
    public function set_sip_drp_option($option = "")
    {
        $status_array = array(
                'no' => gettext('No'),
                'yes' => gettext('Yes')
    ...
    public function set_authtype_drp_option($option = "")
    {
        $status_array = array(
                'basic' => gettext('Basic'),
    ...
    public function set_status_callingcard($status = '')
    {
        $status_array = array(
                '1' => gettext('Active'),
                '0' => gettext('Inactive'),
    ...
    public function set_status_failover($status = '')
    {
        $status_array = array(
                '0' => gettext('No'),
                '1' => gettext('Yes')
    ...
    public function get_status($select = "", $table = "", $status)
    {
    ...
    public function get_status_optin($select = "", $table = "", $status)
    {
        if ($select != 'export') {
            $status_tab = $this->encode($table);
            $status ['table'] = "'" . $status_tab . "'";
    ...
    public function get_email_status($select = "", $table = "", $email_status)
    {
    ...
    public function get_sms_status($select = "", $table = "", $sms_status)
    {
        if ($select != 'export') {
            $status_tab = $this->encode($table);
    ...
    public function get_alert_status($select = "", $table = "", $alert_status)
    {
        if ($select != 'export') {
            $status_tab = $this->encode($table);
    ...
    public function get_routetype($select = "", $table = "", $status)
    {
        return ($status == 0) ? "LCR" : "COST";
    }
    public function get_prorate($select = "", $table = "", $status)
    {
        return ($status == 0) ? "Yes" : "No";
    }
    public function get_import_status($status)
    {
        return strtolower(trim($status)) == 'active' ? 0 : 1;
    }
    public function get_did_status($select, $table, $status)
    {
    ...
    public function get_invoice_date($select, $accountid = 0, $reseller_id, $order_by = 'id')
    {
    ...
    public function convert_to_date($select = '', $table = '', $from_date)
    {
        $from_date = date('Y-m-d', strtotime($from_date));
        return $from_date;
    }
    public function get_account_balance($select = "", $table = "", $amount)
    {
    ...
    public function convert_to_currency($select = "", $table = "", $amount)
    {
        $this->CI->load->model('common_model');
        return $this->CI->common_model->calculate_currency($amount, '', '', true, false);
    }
    public function account_number_icon_new($select = "", $table = "", $number)
    {
        $return_value = '';
        $where = array(
                'number' => $number
        ...
        $this->CI->db->where("deleted", 0);
        $account_res = ( array ) $this->CI->db->get_where("view_accounts_permissions", $where)->first_row();
        if ($account_res ['permission_id'] == 0) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 1) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-secondary" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 2) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 3) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-danger float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 4) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 5) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-success" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 6) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<br><span class="badge badge-warning" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        return $return_value;
    }
    public function account_number_icon($select = "", $table = "", $number)
    {
        $return_value = '';
        $where = array(
                'number' => $number
        ...
        if ($account_res ['type'] == '-1') {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-danger" title="Admin">'.gettext("Super Admin").'</span>';
        }
        ...
        if ($account_res ['type'] == 1) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-secondary" title="Admin">'.gettext("Admin").'</span>';
        }
        if ($account_res ['type'] == 2) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="Subadmin">'.gettext("Subadmin").'</span>';
        }
        ...
        if ($account_res ['permission_id'] == 6) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-warning" title="API">'.gettext("API").'</span>';
        }
        return $return_value;
    }
    public function admin_number_icon($select = "", $table = "", $number)
    {
        $return_value = '';
        $where = array(
                'number' => $number
        ...
        $account_res = ( array ) $this->CI->db->get_where("view_accounts_permissions", $where)->first_row();
        if ($account_res ['permission_id'] == '-1') {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 0) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 1) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-secondary" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 2) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 3) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-danger float-left mt-1" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 4) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-info" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 5) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-success" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if ($account_res ['permission_id'] == 6) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge badge-warning" title="'.$account_res ['permission_name'].'"> '.$account_res ['permission_name'].'</span>';
        }
        if ($number == 'admin') {
            $return_value = " <span title='".gettext('Edit')."'>" . $number . " </span>" . '<span class="badge badge-danger" title="Super Admin">'.gettext("SuperAdmin").'</span>';
        }
        if ($account_res ['permission_id'] > 6) {
            $return_value = " <span title='".gettext('Edit')."'>" . $account_res ['number'] . " </span>" . '<span class="badge" title="'.$account_res ['permission_name'].'">'.$account_res ['permission_name'].'</span>';
        }
        if (!isset($account_res ['permission_id'])) {
            $return_value = " <span title='".gettext('Edit')."'>" . $number . " </span>" . '<span class="badge">"'.$number.'"</span>';
        }
        return $return_value;
    }
    public function convert_to_currency_account($select = "", $table = "", $amount)
    {
        $this->CI->load->model('common_model');
        return $this->CI->common_model->calculate_currency_customer($amount);
    }
    public function get_paid_status($select = "", $table = "", $status)
    {
        return ($status == 1) ? "Paid" : "Unpaid";
    }
    public function set_account_type_recharge($select = "", $table = "", $status)
    {
        return ($status == 1) ? "Postpaid" : "Prepaid";
    }
    public function set_account_type($status = '')
    {
        $status_array = array(
                '0' => gettext('Prepaid'),
                '1' => gettext('Postpaid')
    ...
    public function set_account_type_search($status = '')
    {
        $status_array = array(
                '' => gettext("--Select--"),
                '0' => gettext('Prepaid'),
    ...
    public function get_account_type($select = "", $table = "", $PTE)
    {
        return ($PTE == 1) ? gettext("Postpaid") : gettext("Prepaid");
    }
    public function get_refill_by($select = "", $table = "", $type)
    {
        if ($type == '-1') {
            $type = "Admin";
        } else {
    ...
    public function get_payment_by($select = "", $table = "", $type)
    {
        if ($type == '-1') {
            $type = "Admin";
        } else {
    ...
    public function search_int_type($status = '')
    {
        $status_array = array(
    ...
    public function update_int_type($status = '')
    {
        $status_array = array(
                '1' => gettext('Preserve'),
                '2' => gettext('Set To'),
    ...
    public function update_drp_type($status = '')
    {
        $status_array = array(
                '1' => gettext('Preserve'),
                '2' => gettext('Set To')
    ...
    public function search_string_type($status = '')
    {
        $status_array = array(
    ...
    public function search_mail_to_type($status = '')
    {
        $status_array = array(
                '5' => gettext("Begins With"),
                '1' => gettext('Contains'),
    ...
    public function set_notify_by($status = '')
    {
        $status_array = array(
    ...
    public function convert_to_percentage($select = "", $table = "", $amount)
    {
        return round($amount, 2) . " %";
    }
    public function convert_to_minutes($select = "", $table = "", $amount)
    {
        return str_replace('.', ':', round($amount / 60, 2));
    }
    public function set_filter_type_search($status = '')
    {
        $status_array = array(
    ...
    public function set_routetype_status($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("LCR"),
    ...
    public function attachment_icons($select = "", $table = "", $attachement = "")
    {
        if ($attachement != "") {
    ...
    public function set_despostion($dis = '')
    {
        $status_array = array(
    ...
    public function set_calltype($type = '')
    {
    ...
    public function set_calltype_new()
    {
        $call_type_array = array(
                "" => gettext("--Select--")
        );
        $custom_did_call_types_result = $this->CI->db->get("calltype")->result_array();
    ...
    public function set_calltype_report()
    {
        $call_type_array = array(
                "" => gettext("--Select--")
        );
    ...
    public function set_carrier_report()
    {
        $carrier_array = array(
                "" => gettext("--Select--")
        );
    ...
    public function set_search_status($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Active"),
    ...
    public function set_search_refactor_status($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Scheduled"),
    ...
    public function set_Billing_Schedule_status($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Daily"),
    ...
    public function get_action_buttons($buttons_arr, $linkid)
    {
        $ret_url = '';
        if (! empty($buttons_arr) && $buttons_arr != '') {
            ...
            foreach ($buttons_arr as $button_key => $buttons_params) {
                if ((isset($permissioninfo[$module_name][$sub_module_name][strtolower($button_key)]) && $permissioninfo[$module_name][$sub_module_name][strtolower($button_key)] == 0  or $permissioninfo['login_type'] == '-1' or $permissioninfo['login_type'] == '2' or $permissioninfo['login_type'] == '4' or $permissioninfo['login_type'] == '0' or $permissioninfo['login_type'] == '3')) {
                    ...
                    if (strtoupper($button_key) == "ORDER") {
                        $ret_url .= $this->build_add_orders_button($buttons_params, $linkid);
                    }
    ...
    public function build_delete_button_animap($url, $linkid)
    {
    ...
    public function build_edit_button_animap($button_params, $linkid)
    {
    ...
    public function build_custome_edit_button($button_params, $field, $linkid)
    {
        ...
        if (isset($button_params->layout)) {
            if ($button_params->mode == 'popup') {
                return '<a href="' . $link . '" style="color:#3b3280" rel="facebox_medium" title="'.gettext('Update').'">' . $field . '</a>&nbsp;';
            } else {
                return '<a href="' . $link . '" style="color:#3b3280" title="'.gettext('Edit').'">' . $field . '</a>&nbsp;';
            }
        } else {
            if ($button_params->mode == 'popup') {
                return '<a href="' . $link . '" style="color:#3b3280" rel="facebox" title="'.gettext('Update').'">' . $field . '</a>&nbsp;';
            } else {
                return '<a href="' . $link . '" style="color:#3b3280" title="'.gettext('Edit').'">' . $field . '</a>&nbsp;';
            }
        }
    }
    public function build_edit_button_restore($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
    ...
    public function build_delete_button($url, $linkid)
    {
        $flag = '0';
        $data = explode("/", $url);
        $link = base_url() . $url . "" . $linkid;
    ...
    public function build_view_button($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
            $rel = (isset($button_params->layout) && $button_params->layout != '') ? "facebox_" . $button_params->layout : "facebox";
    ...
    public function build_add_taxes_button($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
            ...
            return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" title="'.gettext('Add Account Taxes').'"><i class="fa fa-reorder fa-fw"></i></a>&nbsp;';
        }
    }
    public function build_add_orders_button($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
            return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" rel="facebox" title="'.gettext('Add Account Order').'"><i class="fa fa-reorder fa-fw"></i></a>&nbsp;';
        } else {
            return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" title="'.gettext('Add Account Order').'"><i class="fa fa-reorder fa-fw"></i></a>&nbsp;';
        }
    }
    public function build_add_download_database_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
        return '<a href="' . $link . '" class="btn btn-royelblue btn-sm "  title="'.gettext('Download Database').'" ><i class="fa-fw fa fa-file-archive-o"></i></a>&nbsp;';
    }
    public function build_add_callerid_button($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
            ...
            return '<a href="' . $link . '" class="btn btn-royelblue btn-sm" title="'.gettext('CallerID').'"><i class="fa fa-mobile-phone fa-fw"></i></a>&nbsp;';
        }
    }
    public function build_start_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;

        return '<a href="' . $link . '" class=""  title="Start" style="text-decoration:none;color: #428BCA;"><b>'.gettext("Start").' |</b></a>&nbsp;';
    }
    public function build_stop_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
        return '<a href="' . $link . '" class=""  title="Stop" style="text-decoration:none;color: #428BCA;" ><b>'.gettext("Stop").' |</b></a>&nbsp;';
    }
    public function build_reload_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
    ...
    public function build_rescan_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
        return '<a href="' . $link . '" class=""  title="rescan" style="text-decoration:none;color: #428BCA;"><b>'.gettext("Rescan").'</b></a>&nbsp;';
    }
    public function build_add_payment_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
        return '<a href="' . $link . '" style="cursor:pointer;color:#3b3280" rel="facebox_medium" title="Refill">PAYMENT</a>&nbsp;';
    }
    public function build_add_download_button($url, $linkid)
    {
        $link = base_url() . $url . "" . $linkid;
        return '<a href="' . $link . '" class="btn btn-royelblue btn-sm"  title="'.gettext('Download Invoice').'" ><i class="fa fa-cloud-download fa-fw"></i></a>&nbsp;';
    }
    public function build_edit_button_resend($button_params, $linkid)
    {
        $link = base_url() . $button_params->url . "" . $linkid;
        if ($button_params->mode == 'popup') {
    ...
    public function get_only_numeric_val($select = "", $table = "", $string)
    {
    ...
    public function mail_to_users($type, $accountinfo, $attachment = "", $amount = "", $filePath = "")
    {
        $subject              = "";
        //		$company_telephone    = "";
    ...
    public function emailFunction($from, $to, $subject, $message, $alert_template = "", $usermobile = "", $sms_message, $company_name = "", $attachment = "", $account_id, $reseller_id, $sip_user_name = '', $callkit_token = '', $status_code = '', $type, $emailstatus = '', $cc_email_ids = '')
    {
    ...
    public function convert_GMT_to($select = "", $table = "", $date, $timezone_id = '')
    {
    ...
    public function convert_GMT_to_noChange($select = "", $table = "", $date, $timezone_id = '')
    {
        return $date;
    }
    public function convert_GMT($date)
    {
        return $this->CI->timezone->convert_to_GMT($date);
    }
    public function convert_GMT_to_new($select = "", $table = "", $date, $timezone_id = '')
    {
    ...
    public function custom_convert_GMT($date, $timezone_id)
    {
        return $this->CI->timezone->convert_to_GMT($date, 1, $timezone_id);
    }
    public function convert_GMT_new($date)
    {
        return $this->CI->timezone->convert_to_GMT_new($date);
    }
    public function convert_to_ucfirst($select = "", $table = "", $str_value)
    {
        return ucfirst($str_value);
    }
    public function set_charge_type($status = '')
    {
        $status_array = array(
                '1' => gettext('Accounts'),
    ...
    public function build_concat_string($select, $table, $id_where = '')
    {
    ...
    public function build_concat_string_carrier($select, $table, $id_where = '')
    {
        $select_params = explode(',', $select);
        $where = array(
                "1"
    ...
    public function build_concat_carrier($select, $table, $id_where = '')
    {
        $select_params = explode(',', $select);
        $where = array(
                "1"
    ...
    public function get_invoice_total($select = '', $table = '', $id)
    {
        $where_arr = array(
                'invoiceid' => $id,
                'item_type <>' => "Gratuita"
    ...
    public function get_array($select, $table_name, $where = false)
    {
        $new_array = array();
        $select_params = array();
        $select_params = explode(",", $select);
    ...
    public function sip_profile_date()
    {
        $defualt_profile_data = '{"rtp-ip":"$${local_ip_v4}","dialplan":"XML","debug":"0","sip-trace":"no","tls":"false","inbound-reg-force-matching-username":"true","disable-transcoding":"true","all-reg-options-ping":"false","unregister-on-options-fail":"false","log-auth-failures":"true","status":"0","inbound-bypass-media":"false","inbound-proxy-media":"false","disable-transfer":"false","enable-100rel":"false","dtmf-duration":"2000","manual-redirect":"true","aggressive-nat-detection":"true","enable-timer":"false","minimum-session-expires":"120","session-timeout-pt":"1800","auth-calls":"true","apply-inbound-acl":"default","inbound-codec-prefs":"$${global_codec_prefs}","outbound-codec-prefs":"$${outbound_codec_prefs}","inbound-late-negotiation":"false","sip-capture":"no","forward-unsolicited-mwi-notify":"false","context":"default","rfc2833-pt":"101","rtp-timer-name":"soft","hold-music":"$${hold_music}","manage-presence":"false","presence-hosts":"$${domain},$${domain_name},$${local_ip_v4}","presence-privacy":"$${presence_privacy}","inbound-codec-negotiation":"generous","auth-all-packets":"false","ext-rtp-ip":"$${local_ip_v4}","ext-sip-ip":"$${local_ip_v4}","force-register-domain":"$${domain}","force-subscription-domain":"$${domain}","force-register-db-domain":"$${domain}","challenge-realm":"auto_to","nonce-ttl":"60","pass-callee-id":"true","dtmf_type":"rfc2833","tls-sip-port":"$${internal_tls_port}","tls-cert-dir":"$${internal_ssl_dir}","tls-bind-params":"transport=tls","tls-version":"$${sip_tls_version}","track-calls":"true","dbname":"share_presence","media_timeout":"300","sip_tls_version":"tlsv1,tlsv1.1,tlsv1.2","media_hold_timeout":"1800","extended-info-parsing":"true","presence-probe-on-register":"false","codec-prefs":"$${global_codec_prefs}","presence-proto-lookup":"false","caller-id-in-from":"true"}';
        return $defualt_profile_data;
    }
    public function set_refill_coupon_status($select = '', $table = '', $status = '')
    {
    ...
    public function get_refill_coupon_status($select = '', $table = '', $status)
    {
        $refill_coupon_array = array(
                '0' => gettext('Unused'),
                '1' => gettext('Active'),
    ...
    public function firstused_check($select = '', $table = '', $status)
    {
    ...
    public function get_refill_coupon_used($select = '', $table = '', $status)
    {
    ...
    public function encode_params($string)
    {
    ...
    public function set_recording($status = '')
    {
        $status_array = array(
                '0' => 'On',
                '1' => 'Off'
    ...
    public function get_automated_report_status($status = '')
    {
        $status_array = array(
            '0' => gettext('Day')
        );
    ...
    public function get_automated_report_weeks($status = '')
    {
        $status_array = array(
            '1' => gettext('Week'),
        );
    ...
    public function get_automated_report_days()
    {
        $day_array = array(
    ...
    public function convert_GMT_to_date($select = "", $table = "", $date, $timezone_id = '')
    {
        return $this->CI->timezone->display_GMT($date, 2, $timezone_id);
    }
    public function set_automated_report_status($select = '', $table = '', $status = '')
    {
    ...
    public function get_automatedreport_date($automated_fields)
    {
    ...
    public function get_automated_report_module($select = '', $table = '', $status = '')
    {
        $decoded_fields = json_decode($status, true);
        return $decoded_fields['module'];
    }
    public function email_status($select = "", $table = "", $status)
    {
        if ($status['status'] == 0) {
            $status = gettext("Sent");
    ...
    public function email_search_status($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Sent"),
    ...
    public function paypal_status($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function playback_audio_notification($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function custom_status($status = '')
    {
        $status_array = array(
                '0' => gettext('Yes'),
                '1' => gettext('No')
    ...
    public function custom_status_recording($status = '')
    {
        $status_array = array(
                '1' => gettext('No'),
                '0' => gettext('Yes')
    ...
    public function custom_status_active($status)
    {
        $status_array = array(
                '0' => gettext('Active'),
                '1' => gettext('InActive')
    ...
    public function custom_status_true($status)
    {
        $status_array = array(
                '0' => gettext('TRUE'),
                '1' => gettext('FALSE')
    ...
    public function custom_status_voicemail($status)
    {
        $status_array = array(
                'true' => gettext('True'),
                'false' => gettext('False')
    ...
    public function create_sipdevice($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function enable_signup($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function balance_announce($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function minutes_announce($status = '')
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function enable_disable_option()
    {
        $option_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disabled')
    ...
    public function paypal_mode($status = '')
    {
        $status_array = array(
                '0' => gettext('Live'),
                '1' => gettext('Sandbox')
    ...
    public function paypal_fee($status = '')
    {
        $status_array = array(
    ...
    public function default_signup_rategroup()
    {
        $this->CI->db->select("id,name");
        $this->CI->db->where("status", 0);
        $this->CI->db->where("reseller_id", 0);
    ...
    public function default_signup_login_type()
    {
        $this->CI->db->select("id,name");
        $this->CI->db->where("reseller_id", 0);
    ...
    public function calling_cards_balance_announce()
    {
        $status_array = array(
                '1' => gettext('Enable'),
                '0' => gettext('Disable')
    ...
    public function calling_cards_timelimit_announce()
    {
        $status_array = array(
                '1' => gettext('Enable'),
                '0' => gettext('Disable')
    ...
    public function calling_cards_rate_announce()
    {
        $status_array = array(
                '1' => gettext('Enable'),
                '0' => gettext('Disable')
    ...
    public function automatic_invoice()
    {
        $status_array = array(
                '0' => gettext('Confirmed'),
                '1' => gettext('Draft')
    ...
    public function renew_deleted_product()
    {
        $status_array = array(
                '0' => gettext('Enable'),
                '1' => gettext('Disable')
    ...
    public function calculate_currency_manually($currency_info, $amount, $show_currency_flag = true, $number_format = true)
    {
    ...
    public function search_report_in($select = '')
    {
        $status_array = array(
    ...
    public function set_summarycustomer_groupby($status = '')
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
    ...
    public function set_summaryprovider_groupby($status = '')
    {
        $status_array = array(
                '' => gettext("--Select--"),
    ...
    public function get_currency_info()
    {
        ...
        } elseif ($currency_result->num_rows() == 1) {
    ...
    public function convert_to_show_in($search_name = "", $table = "", $second)
    {
    ...
    public function group_by_time_new()
    {
        $status_array = array(
                '' => gettext("--Select--"),
                'HOUR' => gettext('Hour'),
    ...
    public function currency_decimal($amount)
    {
    ...
    public function commission_decimal($select, $table, $id_where = '')
    {
    ...
    public function decimal_currency($select, $table, $id_where = '')
    {

        $amount = str_replace(',', '', $id_where);
        return number_format($amount, Common_model::$global_config ['system_config'] ['decimalpoints']);
    }
    public function add_invoice_details($account_arr, $charge_type, $amount, $description)
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
    ...
    public function customer_delete_dependencies($id, $entity = 0)
    {
    ...
    public function reseller_delete_dependencies($id)
    {
    ...
    public function subreseller_list($parent_id = '')
    {
    ...
    public function delete_data($table_name, $where_arr)
    {
        $this->CI->db->where($where_arr);
    ...
    public function update_data($table_name, $where_arr, $update_arr)
    {
        $this->CI->db->where($where_arr);
        if ($table_name == 'accounts') {
            $this->CI->db->where('type <>', '-1');
    ...
    public function select_data($table_name, $where_arr, $select)
    {
        $this->CI->db->where($where_arr);
    ...
    public function set_call_waiting($status = '')
    {
        $status_array = array(
                '0' => 'Enable',
                '1' => 'Disable'
    ...
    public function get_call_waiting($select = "", $table = "", $status)
    {
        return ($status == 0) ? "Enable" : "Disable";
    }
    public function set_invoice_details($select = '')
    {
        $status_array = array(
    ...
    public function reseller_select_value($select, $table, $id_where = '')
    {
        $select_params = explode(',', $select);
    ...
    public function get_subreseller_info($parent_id)
    {
    ...
    public function get_parent_info($child_id, $parent_id)
    {
        if (! empty($child_id)) {
            $str = $child_id . ",";
        } else {
    ...
    public function get_did_accountid($select, $table, $where)
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
    ...
    public function get_status_new($select = "", $table = "", $status = "")
    {
        return ($status ['status'] == 0) ? "<span class='label label-sm label-inverse arrowed-in' title='release'>Active<span>" : "<span class='label label-sm' title='release'>Inactive<span>";
    }
    public function Get_Invoice_configuration($AccountData)
    {
    ...
    public function get_value_by_option($value, $default_value)
    {
    ...
    public function get_account_type_value($value)
    {
        return $value == 'Postpaid' ? '1' : '0';
    }
    public function get_sipinfo_array()
    {
        return array("Random" => "Random");
    }
    public function default_system_type()
    {
        $option_array = array('0' => gettext('Half Year'), '1' => gettext('Year'));
        return $option_array;
    }
    public function set_year_dropdown($type = '')
    {
        if ($type != '') {
            $type = $type."_archive";
        }
    ...
    public function get_did_destination($select = "", $table = "", $id)
    {
        $name = '';
    ...
    public function default_password_input($status = '')
    {
    ...
    public function pin_generate($size = '', $field = '', $tablename = '')
    {
        if ($tablename != '') {
            $accounttype_array = array();
            $uname = rand(pow(10, $size - 1), pow(10, $size) - 1);
    ...
    public function get_reseller_info_company_profile()
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
        $logintype = $this->CI->session->userdata('logintype');
        if ($logintype == 1) {
    ...
    public function set_tax_type($status = '')
    {
        $status_array = array(
                '0' => gettext('Default'),
                '1' => gettext('Other')
    ...
    public function get_tax_type($select = "", $table = "", $status)
    {
        return ($status == 0) ? "Default" : "Other";
    }
    public function set_tax_search_type($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Default"),
    ...
    public function set_cron_type($cron = "")
    {
    ...
    public function get_cron_type($select = "", $table = "", $cron_type)
    {
        $cron_type_array = array(
                "" => gettext("--Select--"),
                'minutes' => gettext('Minute'),
    ...
    public function set_search_cron_type($cron = "")
    {
        $cron_type_array = array(
                "" => gettext("--Select--"),
                'minutes' => gettext('Minute'),
    ...
    public function renewal_type_category($status)
    {
        $status_array = array(
                '' => gettext('--Select--'),
                '0' => gettext('One Time'),
    ...
    public function get_renewal_type_category_list($status = '', $table = "", $category)
    {
    ...
    public function get_renewal_type_category($status = '', $table = "", $id)
    {
    ...
    public function get_available_seconds_for_plans($plan_id = '', $tablename = "", $plan_id2 = "")
    {
    ...
    public function get_type($select = "", $table = "", $type)
    {
    ...
    public function get_number_type($select = "", $table = "", $number_type)
    {
    ...
    public function set_search_number_type($number_type)
    {
        $set_number_type = array(
                "" => gettext("--Select--"),
                '0' => gettext('CLI'),
    ...
    public function get_action_type($select = "", $table = "", $action_type)
    {
    ...
    public function set_search_action_type($action_type)
    {
    ...
    public function set_destination_type($destination_type)
    {
    ...
    public function get_destination_type($select = "", $table = "", $destination_type)
    {
    ...
    public function set_search_destination_type($destination_type)
    {
    ...
    public function set_sync_cdrs_type($cdrs_type)
    {
    ...
    public function get_sync_cdrs_type($select = "", $table = "", $cdrs_type)
    {
    ...
    public function set_search_sync_cdrs_type($cdrs_type)
    {
    ...
    public function varification_with($status = '')
    {
        $status_array = array(
                '0' => gettext('OTP'),
                '1' => gettext('Email')
    ...
    public function ewallet_payment_gateway()
    {
        $paypal_array = array(
    ...
    public function card_payment_gateway()
    {
        $paypal_array = array(
                '0' => gettext('--Select--'),
    ...
    public function authorize_mode($status = '')
    {
        $status_array = array(
                '0' => gettext('Live'),
                '1' => gettext('Sandbox')
    ...
    public function optin_status($select = "", $table = "", $status)
    {
    ...
    public function check_did_available_reseller($select = '', $table = '', $number)
    {
    ...
    public function build_did_forward($select = '', $table = '', $id)
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
        if ($accountinfo['type'] == 0 || $accountinfo['type'] == 3) {
    ...
    public function order_status($status = '')
    {
        $status_array = array(
                '' => gettext('--Select--'),
                '0' => gettext('Pedido Ativo'),
                '1' => gettext('Pedido Inativo')
        );
        return $status_array;
    }
    public function order_date($select = "", $table = "", $date = "")
    {
        $date = $this->convert_GMT_to($select = "", $table = "", $date, $timezone_id = '');
        $converted_date = date("Y-m-d", strtotime($date));
        return $converted_date;
    }
    public function get_did_billing_type($select = "", $table = "", $product_id = "")
    {
    ...
    public function get_localization($select = "", $table = "", $type = '')
    {
    ...
    public function get_order_id($select = '', $table = '', $where)
    {
        if (is_array($where)) {
            $where = $where;
        } else {
    ...
    public function payment_status_icon($select = "", $table = "", $commission_status)
    {
        $return_value = '';
        $where = array(
    ...
    public function set_cli_pool($status = '')
    {
        $status_array = array(
            '0' => 'Disable',
    ...
    public function get_cli_pool($select = "", $table = "", $status)
    {
        $status_array = array(
            '0' => 'Disable',
            '1' => 'DID (CLI Match, If not matched then use random allocated DID)',
    ...
    public function set_product_groupby($status = '')
    {
        $status_array = array(
                '' => gettext("--Select--"),
    ...
    public function group_by_time_for_product()
    {
        $status_array = array(
                '' => gettext("--Select--"),
                'DAY' => gettext("Day"),
    ...
    public function permission_login_type_old($select = "", $table = "", $status)
    {
        return ($status == 0) ? "Admin" : "Reseller";
    }
    public function permission_login_type($select = "", $table = "", $entity_type)
    {
        /*	-1 Super
            0 Cliente
            1 Revenda
    ...
    public function permission_login_type_new($select = "", $table = "", $entity_type)
    {
        $entity_array = array(
                                  '-1' => 'SuperAdmin',
                                    '0' => 'Customer',
    ...
    public function set_search_permission_login_type($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "-1" => gettext("Super Admin"),
                "0" => gettext("Admin"),
                "1" => gettext("Reseller"),
                "2" => gettext("Sub Admin"),
                "3" => gettext("Customer"),
    ...
    public function set_search_permission_login_type_new($select = '')
    {
        $status_array = array(
                "" => gettext("--Select--"),
                "0" => gettext("Administrator"),
                "1" => gettext("Reseller"),
                "2" => gettext("Sub Admin"),
                "3" => gettext("Customer")
        );
    ...
    public function menu_permission_info()
    {
    ...
    public function sub_module_permission_info()
    {
    ...
    public function set_transaction_type($select, $table, $where)
    {
    ...
    public function set_search_localization_type($action_type)
    {
    ...
    public function convert_to_currency_cdrs_debit($select = "", $table = "", $uniqueid)
    {
        $query = $this->CI->db->get_where("cdrs", array("uniqueid" => $uniqueid));
        $data = $query->row_array();
        $this->CI->load->model('common_model');
        if (isset($data['calltype']) && $data['calltype'] == 'Gratuita') {
    ...
    public function direction_search_type($select = '')
    {
    ...
    public function get_price_orders($select = "", $table = "", $orderid)
    {
    ...
    public function check_recording_exist($select = "", $table = "", $uid)
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
    ...
    public function get_call_type_grid($select = "", $table = "", $did_id = "")
    {
    ...
    public function carrier_dropdown($id)
    {
        $drop_down = "";
...
$drop_down .=	'<option value="0">-- ' . gettext("--Select--") . ' --</option>';
    ...
    public function sip_dropdown($id, $accountid, $value)
    {
        $drop_down = "";
        $drop_down .= '<select name="'.$id.'" id="'.$id.'" class="form-control float-left col-md-12 form-control-lg selectpicker '.$id.'" data-live-search="true">';
...
$drop_down .=	'<option value="0">' . gettext("--Select--") . '</option>';
    ...
    public function ipsettigs_account_number_icon($select = "", $table = "", $number)
    {
        $return_value = '';
        $where = array(
                'number' => $number
    ...
    public function refillcoins_cost()
    {
        $status_array = array(
                '0.01' => gettext('0.01'),
                '0.02' => gettext('0.02'),
    ...
    public function coins_consider_for_cost()
    {
    ...
    public function default_pagination_size()
    {
    ...
    public function ios_notification_mode($status = '')
    {
        $status_array = array(
                '0' => gettext('Live'),
                '1' => gettext('Sandbox')
    ...
    public function get_available_seconds_for_package($productid = '', $free_minutes, $used_seconds, $show_seconds = "")
    {
    ...
    public function get_total_available_minutes($free_minutes, $used_seconds)
    {
        $available_seconds =  $free_minutes - $used_seconds;
        return  $available_seconds;
    }
    public function get_current_login_type_timezone()
    {
        return $this->CI->timezone->get_login_type_timezone();
    }
    public function reseller_type_dropdown($status = '')
    {
        $status_array = array(
    ...
    public function get_field_name_balance($select, $table, $where)
    {
        if (is_array($where)) {
            $where = $where;
        } else {
    ...
    public function sip_cid_types($status = '')
    {
        $status_array = array(
                'none' => gettext('None'),
    ...
    public function get_sip_cid_type($select = "", $table = "", $value)
    {
    ...
    public function get_field_name_country_camel($select, $table, $where)
    {
        $timezone_name = $where;
        if (is_array($where)) {
            $where = $where;
    ...
    public function notification_mode($status = '')
    {
        $status_array = array(
            '0' => gettext('FluxSBC'),
    ...
    public function validate_module_access_level($module_name, $type, $module_url = '', $redirect_url = "")
    {
        $accountinfo = $this->CI->session->userdata('accountinfo');
        $permissioninfo = $this->CI->session->userdata('permissioninfo');
        if ($accountinfo['type'] == 1 || $accountinfo['type'] == 2) {
    ...
    public function get_status_voice_broadcast($select = "", $table = "", $status)
    {
        if ($status['status'] == 0) {
    ...
    public function set_routetype_new($status = '')
    {
        $status_array = array( "" => '--Select--','0' => 'LCR','1' => 'Cost','2' => 'Priority','3' => 'Percentage','4' => 'Carrier');
        return $status_array;
    }
    public function set_voice_broadcast_status($status)
    {
        $status_array = array(
                '' => gettext('--Select--'),
    ...
    public function set_cdr_file_mode($status = '')
    {
        $status_array = array(
                'file' => gettext('File'),
                'url' => gettext('URL')
    ...
    public function set_caller_id_type_option($option = "")
    {
        $status_array = array(
                '' => gettext('--Select--'),
    ...
    public function build_unblock_button($button_params, $linkid)
    {
    ...
    public function set_event_guard_status($status = '')
    {
        $status_array = array(
                '' => gettext('--Select--'),
    ...
    public function set_event_guard_filter($status = '')
    {
        $status_array = array(
                '' => gettext('--Select--'),
    ...
    public function event_guard_icon($select = "", $table = "", $log_status)
    {
        $return_value = '';
    ...
    public function get_did_reverse_rate($select = "", $table = "", $status)
    {
    	return ($status == 1) ? gettext ( 'Disabled' ) : gettext ( 'Enabled' );
    }
    public function set_did_reverse_type_search($status = '')
    {
    	$status_array = array (
    			'' => gettext ( "--Select--" ),
    			'0' => gettext ( 'Enabled' ),
		...
		public function block_prefix_types($select = "", $table = "", $block_type)
			{
				$block_type_array = array(
					'outbound' => gettext('Outbound'),
					'inbound' => gettext('Inbound'),
					'both' => gettext('Both')
				);
				return $block_type_array[$block_type];
