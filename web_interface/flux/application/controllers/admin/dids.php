...
class Dids extends Account
{
    ...
    function __construct()
    {
        ...
        // No closing PHP tag to prevent accidental output (intentional)
        $rawinfo = $this->post();
        $this->postdata = array();
    ...
    function _did_purchase()
    {
        ...
        if ($this->accountinfo['reseller_id'] > 0) {
            ...
            $where = array(
                'dids.number'    => $this->postdata['did_number'],
                'dids.status'    => 0,
  ...
  ,reseller_products.product_id', $where, 'reseller_products', 'dids.product_id=reseller_products.product_id', 'inner', "", "", 'DESC', 'dids.id');
    ...
    function _release()
    {
        ...
        $dids_data = $this->db_model->getSelect("*", "dids", array("product_id" => $this->postdata['did_id']))->row_array();
            ...
            if (!empty($did_info)) {
                if ($did_info['accountid'] > 0) {
                    ...
                    if ($did_info['parent_id'] > 0) {
                        ...
                        $this->db->where(array("product_id" => $did_info['product_id']));
    ...
    function _forward()
    {
        ...
        if ($pbx_status == '1') {
            ...
            if ($this->postdata['call_type'] == 11) {
                ...
                $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($time_condition_value) && $time_condition_value != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('timecondition_not_found')), 400)) : $did_info['extensions'];
            }
            if ($this->postdata['call_type'] == 10) {
                ...
                $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($ivr_value) && $ivr_value != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('ivr_not_found')), 400)) : $did_info['extensions'];
            }
            if ($this->postdata['call_type'] == 9) {
                ...
                $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($queue_value) && $queue_value != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('queue_not_found')), 400)) : $did_info['extensions'];
            }
            if ($this->postdata['call_type'] == 8) {
                ...
                $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($conference_value) && $conference_value != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('conference_not_found')), 400)) : $did_info['extensions'];
            }
            if ($this->postdata['call_type'] == 7) {
                ...
                $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($ringgroup_value) && $ringgroup_value != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('ringgroup_not_found')), 400)) : $did_info['extensions'];
            }
        }
        if ($pbx_status != '1') {
        ...
        if (($this->postdata['call_type'] == 0 || $this->postdata['call_type'] == 5) && $this->postdata['call_type_destination'] != "" && $this->postdata['call_type'] != "") {
            ...
            $did_forward['extensions'] = ($this->postdata['call_type_destination'] != "") ? ((!empty($sip_call_type) && $sip_call_type != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('sip_device_not_found')), 400)) : $did_info['extensions'];
        } else {
        ...
        if ($pbx_status != '1') {
            if (($this->postdata['always'] == 0 || $this->postdata['always'] == 5) && $this->postdata['always_destination'] != "" && $this->postdata['always'] != "") {
                ...
                $did_forward['always_destination']  = (!empty($sip_always) && $sip_always != "") ? $this->postdata['always_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('sip_device_not_found')), 400);
            } else {
            ...
            if (($this->postdata['user_busy'] == 0 || $this->postdata['user_busy'] == 5) && $this->postdata['user_busy_destination'] != "" && $this->postdata['user_busy'] != "") {
                ...
                $did_forward['user_busy_destination']   = (!empty($sip_user_busy) && $sip_user_busy != "") ? $this->postdata['call_type_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('sip_device_not_found')), 400);
            } else {
            ...
            if (($this->postdata['user_not_registered'] == 0 || $this->postdata['user_not_registered'] == 5) && $this->postdata['user_not_registered_destination'] != "" && $this->postdata['user_not_registered_destination'] != "") {
                ...
                $did_forward['user_not_registered_destination']  = (!empty($sip_user_not_registered) && $sip_user_not_registered != "") ? $this->postdata['user_not_registered_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('sip_device_not_found')), 400);
            } else {
            ...
            if (($this->postdata['no_answer'] == 0 || $this->postdata['no_answer'] == 5) && $this->postdata['no_answer_destination'] != "" && $this->postdata['no_answer'] != "") {
                ...
                $did_forward['user_not_registered_destination']  = (!empty($sip_no_answer) && $sip_no_answer != "") ? $this->postdata['no_answer_destination'] : $this->response(array('status' => false, 'success' => $this->lang->line('sip_device_not_found')), 400);
            } else {
