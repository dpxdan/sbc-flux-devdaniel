...
class Localization extends MX_Controller
{
    ...
    function localization_save()
    {
        ...
        if ($add_array['id'] == "") {
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->session->set_flashdata('flux_errormsg', ucfirst($add_array['name'].' '.gettext('Localization Added Successfully!')));
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->session->set_flashdata('flux_errormsg', ucfirst($add_array['name']).' '. gettext('Localization Updated Successfully!'));
                redirect(base_url() . 'localization/localization_list/');
                exit();
            }
        }
    ...
    function localization_delete($id)
    {
        ...
        $this->session->set_flashdata('flux_notification', gettext('Localization Removed Successfully!'));
        redirect(base_url() . 'localization/localization_list/');
    }
