...
class Ringgroup extends MX_Controller 
{
    function __construct() {
        ...
        $this->load->library('flux/form','ringgroup_form');
        $this->load->model('ringgroup_model');
        $this->load->library('flux/pbx_feature');
    ...
    function ringgroup_save() {
        ...
        if($add_array['id'] == '') {
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->session->set_flashdata('flux_errormsg', gettext('Ring group added successfully!'));
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->session->set_flashdata('flux_errormsg', gettext('Ring group updated successfully!'));
                redirect(base_url() . 'ringgroup/ringgroup_list/');
                exit ();
            }
        }
    ...
    function ringgroup_delete($id) {
        $this->session->set_flashdata('flux_notification', gettext('Ring group deleted successfully!'));
