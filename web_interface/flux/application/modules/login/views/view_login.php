...
if (isset($invoiceconf['website_title']) && $invoiceconf['website_title'] != '') {
	echo gettext("Login") . " | ";
	echo $invoiceconf['website_title'];
} else {
	echo gettext("Login") . " " . gettext("Flux Telecom - Unindo pessoas e negócios");
}
?>
    </title>
...
<noscript>
	<div id="noscript-warning"><?php echo gettext("FluxSBC work best with JavaScript enabled"); ?></div>
</noscript>
...
if (isset($this->session->userdata['user_logo']) && $this->session->userdata['user_logo'] != "") {
	...
	$logo = 'logo.png';
			...
			<img class="mb-4 img-fluid" style="max-width: 200px;max-height: 300px;" id="logo" alt="login"
			...
			<div class="card px-4 py-5">
				...
				<div class="form-group">
					<input type="text" id="username" class="form-control error_login"
						...
						class="control-label" for="username"><?php echo gettext('Username') ?></label>
				</div>
