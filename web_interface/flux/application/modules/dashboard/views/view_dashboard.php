...
<script type="text/javascript">
    ...
    function get_orders_fail_count(drop_val,year,month){
            ...
            data:{"drop_val":drop_val,"year":year,"month":month},
            success: function(response_data) {     
                $("#orders_fail_count").html(response_data.count);
            }
        });
    }
        ...
        $.ajax({
           ...
           // alert(response_data);
                ...
                if(response_data == ''){
                    ...
                    $("div.call_count_not_data").addClass("second");
                    $("div.call_count_not_data").show();
                    $('div.call_count_not_data').html('<i class="fa fa-meh-o"></i> <?php echo gettext("No Records Found"); ?>');
                }
                else{
        ...
        $.ajax({
            ...
            success: function(response_data) {
                ...
                if(radiobuttonvaluecountry == 'count'){
                    var graphby = "<?php echo gettext('By Calls'); ?>";
                    var graphtip = "<?php echo gettext('Calls'); ?>";
                }
                else{
                    var graphby = "<?php echo gettext('By Minutes'); ?>";
                    var graphtip = "<?php echo gettext('Minutes'); ?>";
                }
...
<label class="dropdown-item">
  <input type="radio" name="calls_pie_chart" id="option2" value="count" class="ace" autocomplete="off" checked> <?php echo gettext("By Calls"); ?>
</label>
<label class="dropdown-item">
  <input type="radio" name="calls_pie_chart" id="option1" value="minutes" class="ace" autocomplete="off"> <?php echo gettext("By Minutes"); ?>
</label>
</div>
</div>
</h3>
...
<div class="card mb-3 dashboard-block">
<h3 class="text-dark p-3">
<i class="fa fa-phone text-primary fa-fw"></i> <?php echo gettext("Top 10 Call Types"); ?>
<div class="dropdown float-right col-5 p-0">
...
<div class="dropdown-menu dropdown-menu-right" aria-labelledby="radioToggle">
<label class="dropdown-item">
  <input type="radio" name="country_pie_chart" id="option22" value="count" class="ace" autocomplete="off" checked> <?php echo gettext("By Calls"); ?>
</label>
<label class="dropdown-item">
  <input type="radio" name="country_pie_chart" id="option11" value="minutes" class="ace" autocomplete="off"><?php echo gettext("By Minutes"); ?>
</label>
</div>
</div>
</h3>
...
<?php
if($this->session->userdata ( 'logintype' ) == 2 || $this->session->userdata ( 'logintype' ) == 4 || $this->session->userdata ( 'logintype' ) == -1)
{
?> 
...
<div class="card mb-3 dashboard-block">
<h3 class="text-dark p-3">
<i class="fa fa-shield text-primary fa-fw"></i> <?php echo gettext("Kernel Version"); ?>                              
</h3>
<div class="card-body">
