                    ...
                    <div class="col-lg-6 pr-lg-2 mb-3">
                        <div class="card mb-3 dashboard-block h-100">
                            <h3 class="text-dark p-3">
                                <i class="fa fa-money text-primary fa-fw"></i>
                                <?php echo gettext("Low Balance"); ?>
                                <a href="<?php echo base_url(); ?>low_balance/low_balance_list/" class="float-right btn btn-secondary">
                                            ...
                                            if ($query->num_rows() > 0) {
                                                ...
                                                foreach ($account_data as $data_key => $accountinformation) {
                                                    ...
                                                    <a href="<?php echo base_url(); ?>accounts/customer_payment_process_add/<?php echo $accountinformation['id']; ?>" rel="facebox">
                                                        <button class="btn btn-secondary" value="<?php echo $accountinformation['id']; ?>" type="button">
                                                            <?php echo gettext("Recharge"); ?>
                                                        </button>
                                                    </a>
                                                    <?php
                                                    echo "</td>";
                    ...
                    <div class="col-lg-6 pl-lg-2 mb-3">
                        <div class="card mb-3 dashboard-block h-100">
                            <h3 class="text-dark p-3">
                                ...
                                <?php echo gettext("Trunk Statistics"); ?>
                                <a href="<?php echo base_url(); ?>summary/provider/" class="float-right btn btn-secondary">
                                    <?php echo gettext("View All"); ?>
                                </a>
                            </h3>

                            <div class="card-body">
                                <div id="trunk-loading" style="display:none;">
                                    ...
                                    <table class="table table-hover">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th><?php echo gettext("Attempted Calls"); ?></th>
                                                <th><?php echo gettext("Completed Calls"); ?></th>
                                                <th><?php echo gettext("ASR"); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody id="trunk_stats_body">
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">
                                                    <?php echo gettext("Loading..."); ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
