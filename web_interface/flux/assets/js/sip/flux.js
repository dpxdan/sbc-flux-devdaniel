...
//          send_agent_cmd('/app/basic_operator_panel/index.php?state=' + state + '');
      ...
      function notifyMe(msg) {
        ...
        if (Notification.permission === "granted") {
          console.log(msg);
          let img = '/assets/images/favicon.ico';
          let notification = new Notification('Flux WebRTC', {
            body: msg,
            icon: img
          });
...
//              console.log('logShow');
          ...
          sipTransfer: function (session) {
            ...
            $modal.find('.transfer-form button.transfercall').on('click', function (e) {
                session
                .transfer($transfer.val().trim())
                .then(function () {
                  console.log('Transfered');
...
//            console.log(r.request.headers);
        ...
        fluxPhone = new WebPhone(data[0], {
          ...
          audioHelper: {
            enabled: true,
            incoming: '/opt/flux/web_interface/flux/application/modules/webrtc/prod/assets/audio/ogg/ringtone_in.ogg'
          },
          ...
          turnServers: [{urls:'turn:181.189.45.113:9579', username : 'fluxDev' , credential: 'FluxDev4SBC201'}],
...
//            localStorage.removeItem('ipApiUser');
          ...
          window.onunload = closePhone;
          isRegistered = true;
          console.log('UA isRegistered: ' + isRegistered);
...
//               console.log('UA Message', arguments);
        ...
        $('#sip-log').delegate('.sipLogClear', 'click', function (event) {
...
//                console.log("Permissão de notificação concedida!");
                var notification = notifyMe("Permissão de notificação concedida!");
                $("#asknotificationpermission").hide();
              }
            });
          } else {
