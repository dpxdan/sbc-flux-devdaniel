(function webpackUniversalModuleDefinition(root, factory) {
  ...
  var turnServerArr = options.turnServers || this.sipInfo.turnServers || ['181.189.45.113:9579'];
  var iceServers = [];
  ...
  var configuration = {
    ...
    transportOptions: {
      wsServers: wsServers,
      traceSip: this.sipInfo.traceSip,
  ...
  this.userAgent = userAgent_1.patchUserAgent(new sip_js_1.UA(configuration), this.sipInfo, options, id);
            ...
            (function(module, exports, __webpack_require__) {
                ...
                exports.patchUserAgent = function(userAgent, sipInfo, options, id) {
                    userAgent.defaultHeaders = ['P-flux-endpoint-id: ' + id, 'Client-id:' + options.appKey, 'P-flux-endpoint-appUser: ' + options.appUser,'P-flux-endpoint-appAgent: ' + options.appAgent];
                    userAgent.media = {};
            ...
            (function(module, exports, __webpack_require__) {
                ...
                var parseFlxHeader = function(session) {
                    var ping = session.request.headers['X-P-Flx'];
                                    ...
                                    receiveResponse: function(response) {
                                        ...
                                        if (response.statusCode === 200) {
                                            ...
                                            var onInfo_1 = function(request) {
                                                ...
                                                session.removeListener('SIP_INFO', onInfo_1);
            ...
            (function(module, exports, __webpack_require__) {
                ...
                var publishQosStats = function(session, qosStatsObj, options) {
                    ...
                    var targetUrl = options.targetUrl || 'flux@sbc.fasterisk.com.br:5080';
                    ...
                    options.extraHeaders.push('p-flux-client-info:' + 'cpuRC=0:0;cpuOS=0:0;netType=' + networkType + ';ram=0:0;effectiveType=' + effectiveType);
            ...
            (function(module) {
                ...
                module.exports = {
                    ...
                    "repository": {
                        "type": "git",
                        "url": "git+https://github.com/dpxdan/flux-web-phone.git"
                    },
                    "publishConfig": {
                    ...
                    "license": "MIT",
                    "bugs": {
                        "url": "https://github.com/dpxdan/flux-web-phone/issues"
                    },
                    "homepage": "https://github.com/dpxdan/flux-web-phone#readme"
                };
...
//# sourceMappingURL=flux-web-phone.js.map
