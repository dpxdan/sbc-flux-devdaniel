...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Nenhum registro disponível na tabela",sInfo:"Exibindo de _START_ até _END_ de um total de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 até 0 total de 0 registros",sInfoFiltered:"(filtrando de um total de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Exibindo _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro encontrado"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
