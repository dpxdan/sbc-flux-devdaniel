(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object')
        ...
        root["FluxPhone"] = root["FluxPhone"] || {}, root["FluxPhone"]["WebPhone"] = factory(root["SIP"], root["getStats"]);
    ...
    return /******/ (function(modules) { // webpackBootstrap
        ...
        ([
            ...
            (function(module, exports, __webpack_require__) {
                ...
                exports.uuidKey = 'flux-webPhone-uuid';
            ...
            (function(module, exports, __webpack_require__) {
                 ...
                 * @Date: Dec. 15, 2024
                 * Copyright © Flux Telecom. All rights reserved.
                 */
                var __awaiter = (this && this.__awaiter) || function(thisArg, _arguments, P, generator) {
                    function adopt(value) {
                        return value instanceof P ? value : new P(function(resolve) {
  ...
  this.appAgent = options.appAgent;
  ...
  var turnServerArr = options.turnServers || this.sipInfo.turnServers || ['sbcdev4.flux.net.br:9579'];
  var iceServers = [];
  ...
  if (isFirefox) {
    sessionDescriptionHandlerFactoryOptions.alwaysAcquireMediaFirst = false;
  }
  ...
  var sipErrorCodes = regData.sipErrorCodes && regData.sipErrorCodes.length ?
    regData.sipErrorCodes : ['408', '502', '503', '504'];
  var wsServers = [];
  ...
  var configuration = {
    ...
    transportOptions: {
      wsServers: wsServers,
      traceSip: typeof options.traceSip === 'undefined' ? true : options.traceSip,
    ...
    register: true,
    hackIpInContact: typeof options.hackIpInContact === 'undefined' ? false : options.hackIpInContact,
    hackWssInTransport: typeof options.hackWssInTransport === 'undefined' ? true : options.hackWssInTransport,
    hackViaTcp: typeof options.hackViaTcp === 'undefined' ? false : options.hackViaTcp,
    registerExpires: 60,
    ...
    userAgentString: 'FluxPhone/6.3.1',
  ...
  this.userAgent = userAgent_1.patchUserAgent(new sip_js_1.UA(configuration), this.sipInfo, options, id);
            ...
            (function(module, exports, __webpack_require__) {
                ...
                exports.patchUserAgent = function(userAgent, sipInfo, options, id) {
                    userAgent.defaultHeaders = ['P-flx-endpoint-id: ' + id, 'Client-id:' + options.appKey, 'P-flx-endpoint-appUser: ' + options.appUser,'P-flx-endpoint-appAgent: ' + options.appAgent];
                    userAgent.media = {};
                    ...
                    userAgent.createFlxMessage = createFlxMessage;
                    ...
                    userAgent.on('notify', function(_a) {
                        ...
                        if (event && event.raw === 'check-sync;reboot=false') {
                            userAgent.emit('provisionUpdate');
                            userAgent.logger.log('UA recieved provision');
                        }
                        this.sendReceiveConfirm;
                ...
                /*--------------------------------------------------------------------------------------------------------------------*/
                function createFlxMessage(options) {
                ...
                function sendMessage(to, messageData) {
                    var userAgent = this;
                    var sipOptions = {};
                    sipOptions.contentType = 'x-flx/agent';
                    sipOptions.extraHeaders = [];
                    sipOptions.extraHeaders.push('P-flx-ws: ' + this.contact);
                    return new Promise(function(resolve, reject) {
                ...
                function register(options) {
                    ...
                    return this.__register.call(this, __assign(__assign({}, options), {
                        extraHeaders: __spreadArrays((options.extraHeaders || []), this.defaultHeaders)
                    }));
                }
                /*--------------------------------------------------------------------------------------------------------------------*/
                function unregister(options) {
                    ...
                    return this.__unregister.call(this, __assign(__assign({}, options), {
                        extraHeaders: __spreadArrays((options.extraHeaders || []), this.defaultHeaders)
                    }));
                }
                ...
                function invite(number, options) {
                    ...
                    options.extraHeaders.push('P-Asserted-Identity: sip:' + (options.contactName || this.sipInfo.username) + '@' + this.sipInfo.domain //FIXME Phone Number
                    );
                    //FIXME Backend should know it already
                    if (options.homeCountryId) {
                        options.extraHeaders.push('P-flx-country-id: ' + options.homeCountryId);
                    }
                 ...
                 * https://sbcdev4.flux.net.br/api-reference/Detailed-Extension-Presence-with-SIP-Event
                 */
                function switchFrom(activeCall, options) {
                    ...
                    replaceHeaders.push('FLX-call-type: replace');
            ...
            (function(module, exports, __webpack_require__) {
                ...
                exports.patchIncomingSession = function(session) {
                    try {
                        parseFlxHeader(session);
                    } catch (e) {
                        session.logger.error("Can't parse Flux headers from invite request due to " + e);
                    }
                    session.canUseFLXMCallControl = canUseFLXMCallControl;
                ...
                /*--------------------------------------------------------------------------------------------------------------------*/
                var parseFlxHeaderString = function(str) {
                    if (str === void 0) {
                        str = '';
                    }
                    var obj = {};
                ...
                var parseFlxHeader = function(session) {
                    var ping = session.request.headers['X-Fs-Support'];
                    var pingCallInfo = session.request.headers['X-P-Flx-Api-Call-Info'];
                    if (ping && ping.length) {
                        var rawInviteMsg = ping[0].raw;
                        ...
                        if (bdyNode) {
                            utils_1.extend(session.flxHeaders, {
                    ...
                    if (pingCallInfo && pingCallInfo.length) {
                        var rawCallInfo = pingCallInfo[0].raw;
                        if (rawCallInfo) {
                            var parsed = parseFlxHeaderString(rawCallInfo);
                            utils_1.extend(session.flxHeaders, parsed);
                        }
                    }
                };
                var mediaCheckTimer = 3000;
                /*--------------------------------------------------------------------------------------------------------------------*/
                function canUseFLXMCallControl() {
                    return !!this.flxHeaders;
                }
                /*--------------------------------------------------------------------------------------------------------------------*/
                function createSessionMessage(options) {
                    ...
                    utils_1.extend(options, {
                        sid: this.flxHeaders.sid,
                        request: this.flxHeaders.request,
                        from: this.flxHeaders.to,
                        to: this.flxHeaders.from
                    });
                    return this.ua.createFlxMessage(options);
                }
                /*--------------------------------------------------------------------------------------------------------------------*/
                function ignore() {
                    return __awaiter(this, void 0, void 0, function() {
                ...
                function sendSessionMessage(options) {
                    return __awaiter(this, void 0, void 0, function() {
                        return __generator(this, function(_a) {
                            if (!this.flxHeaders) {
                                //this.logger.error("Can't send SIP MESSAGE related to session: no Flux headers available");
                            }
                            return [2 /*return*/ , this.ua.sendMessage(this.flxHeaders.from, this.createSessionMessage(options))];
                        });
                    });
                }
                /*--------------------------------------------------------------------------------------------------------------------*/
                                    ...
                                    receiveResponse: function(response) {
                                        ...
                                        if (response.statusCode === 200) {
                                            ...
                                            var onInfo_1 = function(request) {
                                                ...
                                                session.removeListener('FLX_SIP_INFO', onInfo_1);
                                            ...
                                            session.on('FLX_SIP_INFO', onInfo_1);
                                        } else {
                        ...
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [3 /*break*/ , 4];
                                case 2:
                                    return [4 /*yield*/ , session.__unhold()];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
                                case 4:
                ...
                function receiveRequest(request) {
                    ...
                    switch (request.method) {
                        case sip_js_1.C.INFO:
                            ...
                            this.emit('FLX_SIP_INFO', request);
                ...
                function warmTransfer(target, transferOptions) {
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/ , (this.localHold ? Promise.resolve(null) : this.hold())];
                                case 1:
                                    _a.sent();
                                    transferOptions.extraHeaders = (transferOptions.extraHeaders || []).concat(this.ua.defaultHeaders);
                                    this.logger.log('Completing warm transfer' + transferOptions.extraHeaders);
                ...
                function flip(target) {
                    return __awaiter(this, void 0, void 0, function() {
                        return __generator(this, function(_a) {
                            return [2 /*return*/ , sendReceive(this, constants_1.messages.flip, {
                                target: target
                            })];
                        });
                    });
            ...
            (function(module, exports, __webpack_require__) {
                ...
                var formatFloat = function(input) {
                ...
                var calculateStats = function(qosStatsObj) {
                    ...
                    return __assign(__assign({}, qosStatsObj), {
                ...
                var getQoSStatsTemplate = function() {
                    return ({
                        localAddr: '',
                        remoteAddr: '',
                        callID: '',
            ...
            (function(module, exports, __webpack_require__) {
                ...
                var computeRandomTimeout = function(reconnectionAttempts, randomMinInterval, randomMaxInterval) {
                    if (reconnectionAttempts === void 0) {
                        reconnectionAttempts = 1;
                    }
                    if (randomMinInterval === void 0) {
                        randomMinInterval = 0;
                    }
                    if (randomMaxInterval === void 0) {
                        randomMaxInterval = 0;
                    }
                ...
                function __connect(options) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/ , this.__connect(options).catch(function(err) {
            ...
            (function(module) {
                ...
                module.exports = {
                    "name": "flux-web-phone",
                    "version": "1.0.0",
                    "description": "Flux WebRTC",
                    "main": "./lib/index.js",
                    "types": "./lib/index.d.ts",
                    "scripts": {
                        "test": "echo \"Error: no test specified\" && exit 1",
                        "build": "npm run build:tsc && npm run build:webpack",
                        "build-dev": "npm run build:tsc && npm run build:webpack:dev",
                        "build:tsc": "tsc",
                        "build:webpack": "cross-env NODE_ENV=production webpack --config webpack.config.js --progress --color",
                        "build:webpack:dev": "cross-env NODE_ENV=development webpack --config webpack.config.js --progress --color"
                    },
                    "repository": {
                        "type": "git",
                        "url": "git+https://github.com/Flux-Cloud/flux-web-phone.git"
                    },
                    "publishConfig": {
                        "@dpxdan:registry": "https://npm.pkg.github.com"
                    },
                    "dependencies": {
                    ...
                    "devDependencies": {
                        ...
                        "dotenv": "8.0.0",
                        "eslint": "6.8.0",
                        "eslint-config-flux-typescript": "3.0.0",
                        "expose-loader": "^3.0.0",
                        "express": "^4.15.3",
                        "file-loader": "^0.11.2",
                    ...
                    "author": "Daniel Paixao",
                    "license": "MIT",
                    "bugs": {
                        "url": "https://github.com/Flux-Cloud/flux-web-phone/issues"
                    },
                    "homepage": "https://github.com/Flux-Cloud/flux-web-phone#readme"
                };
