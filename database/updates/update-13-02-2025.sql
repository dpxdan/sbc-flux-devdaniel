INSERT INTO `flux`.`roles_and_permission` (`login_type`, `permission_type`, `menu_name`, `module_name`, `module_url`, `display_name`, `permissions`, `status`, `creation_date`, `priority`) VALUES ('0', '0', 'switch', 'localization', 'localization_list', 'Localizations', '[\"main\",\"list\",\"create\",\"edit\",\"delete\",\"search\"]', '0', '2019-01-25 09:01:03', '2.26000');

UPDATE `flux`.`roles_and_permission` SET `login_type` = '0' WHERE (`id` = '59');
UPDATE `flux`.`roles_and_permission` SET `login_type` = '0' WHERE (`id` = '58');

UPDATE `flux`.`roles_and_permission` SET `status` = '1' WHERE (`id` = '13');
...
INSERT INTO `flux`.`cron_settings` (`id`, `name`, `command`, `exec_interval`, `creation_date`, `last_modified_date`, `last_execution_date`, `next_execution_date`, `status`, `file_path`) VALUES (10, 'Refactor Service', 'minutes', 1, '2025-02-12 16:48:34', '2025-02-12 17:10:37', '2025-02-13 18:48:02', '2025-02-13 18:49:02', 0, 'wget --no-check-certificate -q -O- {BASE_URL}Refactor/index/');

INSERT INTO `flux`.`menu_modules` (`menu_label`, `module_name`, `module_url`, `menu_title`, `menu_image`, `menu_subtitle`, `priority`) VALUES ('Refactor', 'price', 'pricing/price_refactor/', 'Tariff', 'pricelist.png', '0', 40.2);
